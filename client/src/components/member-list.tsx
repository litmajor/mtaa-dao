    ...
    <div className="relative">
      ...
      <Card className="relative backdrop-blur-sm bg-white/90 border-0 shadow-2xl shadow-emerald-500/10 rounded-2xl overflow-hidden">
        ...
        <CardContent className="p-6 space-y-4">
          ...
          {/* Enhanced CTA button */}
          <div className="pt-4">
            <Button variant="primary" className="w-full font-semibold py-3 rounded-xl shadow-lg shadow-emerald-500/25 transition-all duration-300 hover:shadow-xl hover:scale-105">
