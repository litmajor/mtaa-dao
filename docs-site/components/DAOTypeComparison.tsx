...
export function DAOTypeComparison() {
  ...
  return (
    <div className="my-8">
      ...
      >
        <h3 className="text-2xl font-bold mb-4">{daoTypes[selected].type}</h3>
        
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            <p className="text-sm text-gray-600 mb-1">Duration</p>
            <p className="font-semibold text-lg">{daoTypes[selected].duration}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600 mb-1">Creation Fee</p>
            <p className="font-semibold text-lg">{daoTypes[selected].fee}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600 mb-1">Best For</p>
            <p className="font-semibold text-lg">{daoTypes[selected].ideal}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600 mb-1">Upgrade Path</p>
            <p className="font-semibold text-lg">{daoTypes[selected].upgrade}</p>
          </div>
        </div>

        <div>
          <p className="text-sm text-gray-600 mb-2">Example Use Cases:</p>
